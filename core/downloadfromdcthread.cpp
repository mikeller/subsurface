...
bool OstcFirmwareCheck::checkLatest(QWidget *_parent, device_data_t *data)
{
	devData = *data;
	parent = _parent;
...
{
	return latestFirmwareHexFile.toString();
}
...
QString OstcFirmwareCheck::getFirmwareOnDeviceString()
{
	return firmwareOnDeviceString;
}

void OstcFirmwareCheck::upgradeFirmware(const QString &filename, ConfigureDiveComputer *configureDiveComputer)
{
